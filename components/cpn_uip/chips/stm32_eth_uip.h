...
#ifndef __STM32_ETH_UIP_H
#define __STM32_ETH_UIP_H
...
#if ((defined ETH_MII_MODE) && (defined ETH_RMII_MODE))
    #error "ETH_MODE define error!"
#endif
/**
  * @}
  */
