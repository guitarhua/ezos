...
**********************************************************************
*/
#define SHOW_GUIDEMO_BITMAP            (1)                  // BITMAP图像显示
#define SHOW_GUIDEMO_COLORBAR          (1)                  // 彩色渐变条纹
#define SHOW_GUIDEMO_CURSOR            (1)                  // 游标图片
#define SHOW_GUIDEMO_GRAPH             (1)                  // 图形控件. 示例为心跳及sin波形
#define SHOW_GUIDEMO_LISTVIEW          (1)                  // 列表控件
#define SHOW_GUIDEMO_SPEED             (1)                  // 高速刷图(色块乱闪)
#define SHOW_GUIDEMO_TREEVIEW          (0)                  // 树形列表控件 及 浮标
#define SHOW_GUIDEMO_ICONVIEW          (0)                  // 图标菜单按钮, 耗RAM!
#define SHOW_GUIDEMO_RADIALMENU        (0)                  // 放射状图标选择, 耗RAM!
#define SHOW_GUIDEMO_VSCREEN           (0)                  // 虚拟屏幕, 必须 VXSIZE_PHYS/VYSIZE_PHYS 设置比实际窗口大!
#define SHOW_GUIDEMO_AUTOMOTIVE        (0)                  // 速度仪表盘
#define SHOW_GUIDEMO_TRANSPARENTDIALOG (0)                  // 半透明弹出框
#define SHOW_GUIDEMO_AATEXT            (1)                  // 字体抗锯齿
#define SHOW_GUIDEMO_BARGRAPH          (0)                  // 柱状图控件, 耗MEMDEV
#define SHOW_GUIDEMO_FADING            (0)                  // 界面切换渐变效果 (效果不好!)
#define SHOW_GUIDEMO_SKINNING          (1)                  // 自定义皮肤
#define SHOW_GUIDEMO_SPEEDOMETER       (0)                  // 速度计, 会一直等待操作...
#define SHOW_GUIDEMO_IMAGEFLOW         (0)					// 图像流, 动画. XSIZE_PHYS = 320, VYSIZE_PHYS >= 480 方可! (没看到完整效果)
...
#define GUIDEMO_USE_VNC         (0)    // 非 RTOS 不支持此项, 而且需要网络功能
