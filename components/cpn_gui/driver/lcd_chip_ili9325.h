...
#ifndef __LCD_CHIP_ILI9325_H
#define __LCD_CHIP_ILI9325_H
...
{
    lcd_bus_cmd_wr(0xe3,0x3008);
    lcd_bus_cmd_wr(0xe7,0x0012);
    lcd_bus_cmd_wr(0xef,0x1231);        // Set the internal vcore voltage
