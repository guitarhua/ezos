...
#define COLOR_CONVERSION                GUICC_M565                              ///< 色彩转换模式, 屏幕16位色RGB为 GUICC_M565, BGR为 GUICC_565

// 开启以下功能会影响刷屏速度, 建议直接修改 LCD 底层驱动, 使视域XY轴和实际XY轴一致!!!
#define LCD_MIRROR_X                    1                                       ///< LCD 实际X轴镜像
#define LCD_MIRROR_Y                    1                                       ///< LCD 实际Y轴镜像
#define LCD_SWAP_XY                     0                                       ///< LCD 实际XY轴互换

#define TOUCH_MIRROR_X                  1                                       ///< 触摸屏实际X轴镜像
#define TOUCH_MIRROR_Y                  0                                       ///< 触摸屏实际Y轴镜像
#define TOUCH_SWAP_XY                   1                                       ///< 触摸屏实际XY轴互换
...
/-----------------------------------------------------------------------------*/
    ...
    #define TOUCH_CS_PORT                   GPIOB                               ///< 触摸驱动芯片片选信号的PORT口
    #define TOUCH_CS_CLK                    RCC_APB2Periph_GPIOB                ///< 触摸驱动芯片片选信号的时钟模块
    #define TOUCH_CS_PIN                    GPIO_Pin_7                          ///< 触摸驱动芯片片选信号的PIN口
