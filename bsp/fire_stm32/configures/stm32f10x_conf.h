...
/// 是否使能断言功能进行调试, 会增加代码量, 不使能则不进行宏定义
...
/// LED硬件配置
#define LED_NUM                         3                                       ///< 设置LED的数量, 该驱动最多允许16个LED灯
#define LED_LEVEL                       0                                       ///< 0, 低电平点亮LED. 1, 高电平点亮LED
#define LED_ADVANCED_ENABLE                                                     ///< 使能LED的高级功能, 包括闪烁和渐变效果

#define LED0_PORT                       GPIOC                                   ///< 设置该LED的PORT口
#define LED0_CLK                        RCC_APB2Periph_GPIOC                    ///< 设置该LED的时钟模块
#define LED0_PIN                        GPIO_Pin_3                              ///< 设置该LED的PIN口
...
#define KEY0_PORT                       GPIOB                                   ///< 设置该按键的PORT口
#define KEY0_CLK                        RCC_APB2Periph_GPIOB                    ///< 设置该按键的时钟模块
#define KEY0_PIN                        GPIO_Pin_0                              ///< 设置该按键的PIN口
...
/// 控制引脚硬件配置
#define CTRLPORT_NUM                    4                                       ///< 设置控制引脚的数量. 该驱动最多允许16个控制引脚.

#define CTRLPORT0_PORT                  GPIOE                                   ///< 设置该控制引脚的PORT口
#define CTRLPORT0_CLK                   RCC_APB2Periph_GPIOE                    ///< 设置该控制引脚的时钟模块
...
#define EXTINT_NUM                      1                                       ///< 设置外部中断数量.该驱动最多允许5个外部中断
...
#if (EXTINT_NUM > 0)
    #define EXTINT0_PORT                GPIOB                                   ///< 设置外部中断PORT口
    #define EXTINT0_CLK                 RCC_APB2Periph_GPIOB                    ///< 设置外部中断PORT口时钟模块
    #define EXTINT0_PORT_SOURCE         GPIO_PortSourceGPIOB                    ///< 设置外部中断PORT口源
    #define EXTINT0_PIN                 GPIO_Pin_13                             ///< 设置外部中断PIN口
    #define EXTINT0_PIN_SOURCE          GPIO_PinSource13                        ///< GPIO_Pin_X, 则设置为 GPIO_PinSourceX
    #define EXTINT0_LINE                EXTI_Line13                             ///< GPIO_Pin_X, 则设置为 EXTI_LineX
    ...
    #define EXTINT0_IRQ_HANDLER         EXTI15_10_IRQHandler                    ///< 外部中断函数名
    ...
    #define EXTINT0_IRQ_PRIORITY        0x0                                     ///< 设置中断优先级. 高2位为可抢占主优先级, 低2位为非抢占的子优先级
#endif
...
/// SPI硬件配置
#define SPI_NUM                         4                                       ///< 设置使用的SPI数量.该驱动最多允许5个SPI数
...
/// 网络接口配置
#define ENC28J60_UIP_ENABLE                                                     ///< 启用enc28j60驱动
    ...
    #define ENC28J60_CS_PORT            GPIOA                                   ///< ENC28J60片选信号的PORT口
    #define ENC28J60_CS_CLK             RCC_APB2Periph_GPIOA                    ///< ENC28J60片选信号的时钟模块
    #define ENC28J60_CS_PIN             GPIO_Pin_4                              ///< ENC28J60片选信号的PIN口
#endif
...
// SPI FLASH 通讯模式宏定义, 注意只能选一个
#define SPIFLASH_UNIVERSAL                                                      ///< 选择SPI FLASH通用驱动
...
/// 曲调组件使能
#define TONE_ENABLE
#define TONE_OUT                        BELL                                    ///< 设置振铃IO口, 由"drv_ctrlport"提供功能
